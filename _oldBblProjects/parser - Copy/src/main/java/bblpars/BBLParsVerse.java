...
public class BBLParsVerse {
    ...
    List<Referenca> references = new ArrayList<>();
    ...
    public List<Referenca> getReferences() {
        return references;
    }

    public void setReferences(List<Referenca> references) {
    ...
    /*public void setReference(Referenca reference) {
        this.reference = reference;
    }

    public Referenca getReference() {
        return reference;
    }*/
}
